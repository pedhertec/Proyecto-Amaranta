        ...
        return acc + `
            <div class="cardsOfertas">
                ...
                <div class="cuerpoCard">
                    <img src=${element.imgindex[0]} alt=${element.producto}>
                    <p>
                    ${element.description}
                    </p>        
                    <p>
...
contenedorCards.innerHTML = productosAHtml(productosEnOferta)
...
const subirAlCarrito = () => {
    ...
    botonComprar.forEach( btn => {
        btn.onclick = () => {     
            ...
            const producto = buscarProducto(recortarId, productosEnOferta)
